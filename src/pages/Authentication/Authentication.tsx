  ...
  return (
    <>
      <div className="grid lg:grid-cols-2 lg:min-w-full min-h-screen absolute max-[1025px]:left-[20%] max-[1025px]:top-[5%]" >
        <div data-testid="logo" className="flex justify-center items-center relative">
          <img src={logo} alt="Logo" className='max-[1025px]:absolute max-[1025px]:left-[0%] max-[1025px]:top-[0%]  min-[1025px]:w-[50vh] max-[1025px]:w-[15vh] min-[1025px]:h-[50vh] max-[1025px]:h-[15vh] ' />
        </div>
