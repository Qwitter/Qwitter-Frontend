...
jest.mock("../../../components/SignUpSteps/SignUpSteps.tsx", () => {
    return {
        SignUpSteps: () => <div data-testid="MockedSignUp-Test-Id">this is SignUpSteps Page</div>
    };
})

jest.mock("../../login/Login.tsx", () => {
    return {
        Login: () => <div data-testid="MockedLogin-Test-Id">this is Login Page</div>
    };
})
...
describe("Authentication Unit Testing", () => {
    it('Sign Up with Google and Apple Testing', () => {
        ...
        // Check Existence of googleSignUpButton and appleSignUpButton
        const googleSignUpButton = screen.getByText("Sign up with Google");
        const appleSignUpButton = screen.getByText("Sign up with Apple");

        expect(googleSignUpButton).toBeTruthy();
        expect(appleSignUpButton).toBeTruthy();
        //TODO: Check Functionality  of googleSignUpButton and appleSignUpButton
