  ...
  return (
    <div className="w-full flex flex-col items-start justify-start">
      ...
      <div className="w-full h-[100px] mt-[85px]">
        <Button
          size="full"
          className="h-[50px] my-6 font-bold"
  ...
  return (
    <div className="w-full flex flex-col items-start justify-start">
      ...
      <p className="mt-10 text-[15px] text-gray leading-4">
        By signing up, you agree to our Terms, Privacy Policy, and Cookie Use. X
        may use your contact information, including your email address and phone
        number for purposes outlined in our Privacy Policy. Learn more
      </p>
      <div className="w-full h-[100px] mt-[177px]">
        <Button
          size="full"
          className="h-[50px] my-6 font-bold"
          onClick={props.handleNextStep}
...
const Step3 = (props: NextSignUpStepProp) => {
  ...
  return (
    <div className="w-full flex flex-col items-start justify-start">
      ...
      <p className="text-[13px] mt-[65.2px] text-gray leading-4">
      ...
      <div className="w-full h-[100px] mt-[15px]">
        <Button
          variant="secondary"
          size="full"
          className="h-[50px] my-6 font-bold"
...
const Step5 = (props: NextSignUpStepProp) => {
  ...
  return (
    <div className="w-full flex flex-col items-start justify-start">
      ...
      <div className="w-full h-[100px] mt-[311.5px]">
        <Button
          variant="secondary"
          size="full"
          className="h-[50px] my-6 font-bold"
