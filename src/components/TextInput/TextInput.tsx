    ...
    return (
      <>
        <div className={cn("relative w-full flex flex-row pt-3", className)}>
          ...
          <label className="absolute inline text-[17px] font-normal text-black dark:text-gray duration-300 transform -translate-y-4 scale-75 top-7 z-10 origin-[0] left-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4">
            {placeHolder}
          </label>
        </div>
        {(errorMessage && (
