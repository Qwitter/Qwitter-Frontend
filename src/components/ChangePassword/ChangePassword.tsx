...
export function ChangePassword() {
  ...
  const onSubmit = ({ Password }: { Password: string }) => {
    mutate({ password: Password, token: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ImExZjk0MDRmLWI1ODEtNDhmZS05NTM1LTlmNzE1YzBmZThkOSIsImlhdCI6MTY5OTcxMjA0NCwiZXhwIjoxNzAwNTc2MDQ0fQ.2B2g_Z_6AXY-RUuf_dLRI8L5w0UIapAAKBglWuIJ8RU" });
  };
  if (isPending) {
    return (
